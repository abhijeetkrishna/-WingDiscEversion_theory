...
var_dict = {
    ...
    'tol_by_dt':1e-8,
    'isotropic_contribution':"no", #no or all
    'anisotropic_contribution':"rearrangement", #all or no or elongation or rearrangement
    'height_contribution':"no", #no or all
    'genotype':"ecadGFPnbG4myoVI",#"ecadGFPnbG4",#"fit_lambdas_df_ecadGFPnbG4.pkl", #fit_lambdas_df_ecadGFPnbG4myoVI.pkl
...
thick_mesh_file = "/projects/project-krishna/WingDiscEversion_theory/Simulations/meshes/icosaspherical_cap/"
try:
    thick_mesh_file = thick_mesh_file + f"pickle/IcoSph_mesh_w_basis_vectors_refine_factor_{mesh_refine_factor}_thickness_0.1_angle_of_rotation_{angle_of_rotation}_theta_max_{theta_max}_theta_DV_{theta_DV}.pkl"
except:
    thick_mesh_file = thick_mesh_file + f"pickle/IcoSph_mesh_w_basis_vectors_refine_factor_{mesh_refine_factor}_thickness_0.1_angle_of_rotation_{angle_of_rotation}_theta_max_{theta_max}_theta_DV_{int(theta_DV)}.pkl"
print("getting mesh")
